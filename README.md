...
Te damos la bienvenida a la **plataforma de laboratorios** del curso **Robot Framework**. Aquí podrás explorar diferentes tecnologías a través de prácticas guiadas. ¡Desarrolla tus habilidades y lleva tus conocimientos al siguiente nivel!
...
### [Práctica1: Instalación del entorno y ejecución del primer test case](Capitulo01/Practica1.md)
...
### [Práctica 2: Análisis del reporte HTML generado](Capitulo01/Practica2.md)
...
### [Práctica 3: Suite estructurada con keywords reutilizables y archivo Resource](Capitulo02/Practica3.md)
...
### [Práctica 4: Parametrización con Setup/Teardown y filtrado por tags](Capitulo02/Practica4.md)
...
### [Práctica 5: Tests con lógica condicional y bucles de datos](Capitulo03/Practica5.md)
...
### [Práctica 6: Suite robusta con manejo de fallas y recuperación](Capitulo03/Practica6.md)
...
### [Práctica 7: Escritura de escenarios BDD para un flujo comercial de telecomunicaciones](Capitulo04/Practica7.md)
...
### [Práctica 8: Refactorización de test tradicional a modelo BDD con separación de capas](Capitulo04/Practica8.md)
...
### [Práctica 9: Suite data-driven con CSV y segmentación por tags](Capitulo05/Practica9.md)
...
### [Práctica 10: Creación de librería Python personalizada e integración en suite](Capitulo05/Practica10.md)
...
### [Práctica 11: Automatización de flujo de login y navegación E2E](Capitulo06/Practica11.md)
...
### [Práctica 12: Suite web con Page Object y captura de evidencias completas](Capitulo06/Practica12.md)
...
### [Práctica 13: Suite de pruebas API con autenticación Bearer y validación JSON](Capitulo07/Practica13.md)
...
### [Práctica 14: Suite API data-driven: smoke y regresión desde CSV](Capitulo07/Practica14.md)
...
### [Práctica 15: Proceso RPA con lectura de Excel, transformación y generación de reporte PDF](Capitulo08/Practica15.md)
...
### [Práctica 16: Proceso RPA end-to-end: web + API + archivos con checklist de calidad](Capitulo08/Practica16.md)
...
### [Práctica 17: Ejecución avanzada por CLI con filtros de tags y regeneración de reportes](Capitulo09/Practica17.md)
  ...
  - ⏱️Duración estimada: 54 min
    
### [Práctica 18: Simulacro RFCP y proyecto final integrador](Capitulo09/Practica18.md)
